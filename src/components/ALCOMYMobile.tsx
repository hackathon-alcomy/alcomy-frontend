...
import SegmentToggle, { Mode } from "./SegmentToggle";
import SearchBar from "./SearchBar";

export default function ALCOMYMobile(): JSX.Element {
      ...
      <div className="mx-auto max-w-[360px] px-5 py-5">
        ...
        <article className="mb-[18px] flex gap-[14px]">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-2 text-[12px] leading-[1.65]">
              칵테일 설명 칵테일 설명칵테일의 설명 칵테일 설명 칵테일 설명칵테일의 설명 칵테일 설명
              칵테일 설명칵테일의 설명 칵테일 설명 칵테일 설명칵테일의 설명 칵테일
            </p>
          </div>
        </article>
        ...
        <article className="mb-[26px] flex gap-[14px]">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-[2px] text-[11px] text-[#6b7280]">소주보다 쉬운</div>
            <p className="mt-2 text-[12px] leading-[1.65]">
              칵테일 설명 칵테일 설명 칵테일의 설명 칵테일 설명 칵테일 설명칵테일의 설명 칵테일 설명
              칵테일 설명칵테일의 설명 칵테일 설명 칵테일 설명칵테일의 설명 칵테일
            </p>
          </div>
        </article>
        ...
        <article className="flex gap-[14px]">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-2 text-[12px] leading-[1.65]">
              설명이 들어옵니다. 설명이 들어옵니다. 설명이 들어옵니다. 설명이 들어옵니다. 설명이
              들어옵니다. 설명이 들어옵니다. 설명이 들어옵니다. 설명이 들어옵니다. 피
            </p>
          </div>
        </article>
      </div>
